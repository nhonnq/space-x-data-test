...
open class RecyclerAdapterWrapper(val wrappedAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>) :
    ...
    override fun getItemId(position: Int): Long {
        return (wrappedAdapter as BaseAdapter<*, *>).getItemId(position)
    }
